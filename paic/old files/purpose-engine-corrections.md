...
### 0. WRONG PRIMARY COLOR (MOST CRITICAL)
**Problem:** The entire prototype uses `#00838F` (teal) which is NOT an official Uplift color!
**Official Color:** Uplift Blue is `#0067b1` (PMS 293) per the Style Guide
**Impact:** Every primary-colored element needs to be updated
**Fix:** Global find/replace:
```
#00838F → #0067b1 (primary)
#006064 → #004b85 (dark)
#4DB6AC → #5091cd (light)
rgba(0, 131, 143 → rgba(0, 103, 177 (all opacity variants)
```
...
### Colors (OFFICIAL Uplift Brand)

```css
/* Official Uplift (from Style Guide PMS) */
Primary Blue:   #0067b1 (PMS 293) ← CORRECT
Dark Blue:      #004b85 (PMS 295)
Light Blue:     #5091cd (PMS 279)
Yellow:         #ffc425 (PMS 123)
Orange:         #f15d22 (PMS 179)
Gray:           #8e8e91 (PMS 877)
...
/* ⚠️ WRONG - DO NOT USE */
#00838F (teal) ← This is NOT Uplift blue!
#006064 (dark teal) ← Wrong
#4DB6AC (light teal) ← Wrong
```
